...
final class ReportsPagination
{
    public const SORT_CATEGORY_ASC = 'category_asc';
    public const SORT_CATEGORY_DESC = 'category_desc';
    ...
    public static function createConfig(): PaginationConfig
    {
        return new PaginationConfig(
            self::LIMIT_DEFAULT,
            self::LIMIT_MAX,
            self::SORT_CATEGORY_ASC,
            [
                new SortSpec(
                    self::SORT_CATEGORY_ASC,
                    new KeySpec('category', KeySpec::TYPE_STRING, SortDirection::ASC),
                    [
                ...
                new SortSpec(
                    ...
                    new KeySpec('category', KeySpec::TYPE_STRING, SortDirection::DESC),
                    [
