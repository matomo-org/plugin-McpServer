...
class ApiCallRead extends AbstractApiCall
{
    public const TOOL_NAME = 'matomo_api_call_read';

    protected function init(): void
    {
        $this->name = self::TOOL_NAME;
        $this->description = "Use when: you need to execute a known read-only Matomo API method directly.\n"
    ...
    {
        return ApiMethodOperationClassifier::CATEGORY_READ;
    }
}
