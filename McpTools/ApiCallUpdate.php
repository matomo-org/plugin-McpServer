...
class ApiCallUpdate extends AbstractApiCall
{
    public const TOOL_NAME = 'matomo_api_call_update';

    protected function init(): void
    {
        $this->name = self::TOOL_NAME;
        $this->description = "Use when: you need to execute a known update-style Matomo API method directly.\n"
    ...
    {
        return ApiMethodOperationClassifier::CATEGORY_UPDATE;
    }
}
