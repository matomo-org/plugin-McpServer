...
class SiteSearchTest extends IntegrationTestCase
{
    ...
    public function testRejectsEmptySearch(): void
    {
        ...
        McpTestHelper::callToolAndAssertError(
            ...
            ['search' => '   '],
            "Parameter 'search' missing or invalid.",
            __METHOD__
        );
    }
    ...
    public function testSupportsSortByIdDesc(): void
    {
        ...
        $content = McpTestHelper::callToolAndAssertSuccess(
            ...
            $sessionId,
            SiteSearch::TOOL_NAME,
            ['search' => 'Test Site', 'limit' => 3, 'sort' => SitesPagination::SORT_ID_DESC],
            __METHOD__
        );
        $sites = $content['sites'] ?? null;
        self::assertIsArray($sites);
    ...
    public function testIdPaginationIncludesNewRowsAddedAfterFirstPageWhenTheySortAfterCursor(): void
    {
        ...
        $firstPage = McpTestHelper::callToolAndAssertSuccess(
            ...
            $sessionId,
            SiteSearch::TOOL_NAME,
            ['search' => 'MCP Test Site', 'limit' => 2, 'sort' => SitesPagination::SORT_ID_ASC],
            __METHOD__ . '#1'
        );
        ...
        $secondPage = McpTestHelper::callToolAndAssertSuccess(
            ...
            [
                ...
                'limit' => 2,
                'sort' => SitesPagination::SORT_ID_ASC,
    ...
    public function testNamePaginationDoesNotBackfillRowsAddedBeforeCursorBoundary(): void
    {
        ...
        $firstPage = McpTestHelper::callToolAndAssertSuccess(
            ...
            $sessionId,
            SiteSearch::TOOL_NAME,
            ['search' => 'MCP Test Site', 'limit' => 2, 'sort' => SitesPagination::SORT_NAME_ASC],
            __METHOD__ . '#1'
        );
        $sites = $firstPage['sites'] ?? null;
        self::assertIsArray($sites);
    ...
    public function testRejectsCursorSortMismatch(): void
    {
        ...
        $firstPage = McpTestHelper::callToolAndAssertSuccess(
            ...
            $sessionId,
            SiteSearch::TOOL_NAME,
            ['search' => 'Test Site', 'limit' => 1, 'sort' => SitesPagination::SORT_ID_DESC],
            __METHOD__ . '#1'
        );
        ...
        McpTestHelper::callToolAndAssertError(
            ...
            $sessionId,
            SiteSearch::TOOL_NAME,
            ['search' => 'Test Site', 'cursor' => $nextCursor, 'sort' => SitesPagination::SORT_NAME_ASC],
            'Invalid cursor.',
            __METHOD__ . '#2'
        );
    }
    ...
    public function testRejectsCursorFromSiteListContext(): void
    {
        $server = McpTestHelper::buildServer();
        $sessionId = McpTestHelper::initializeSession($server);

        $listPage = McpTestHelper::callToolAndAssertSuccess(
            $server,
            $sessionId,
            SiteList::TOOL_NAME,
            ['limit' => 1, 'sort' => SitesPagination::SORT_NAME_ASC],
            __METHOD__ . '#1'
        );
        $nextCursor = $listPage['next_cursor'] ?? null;
        self::assertIsString($nextCursor);
