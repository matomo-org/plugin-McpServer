...
final class DiscoveryState
{
     ...
     */
    public function __construct(private readonly array $tools = [], private readonly array $resources = [], private readonly array $prompts = [], private readonly array $resourceTemplates = [])
    {
    }
    /**
    ...
    {
        return new self(array_diff_key($this->tools, $next->tools), array_diff_key($this->resources, $next->resources), array_diff_key($this->prompts, $next->prompts), array_diff_key($this->resourceTemplates, $next->resourceTemplates));
    }
    /**
    ...
    {
        return empty($this->tools) && empty($this->resources) && empty($this->prompts) && empty($this->resourceTemplates);
    }
    /**
    ...
    {
        return \count($this->tools) + \count($this->resources) + \count($this->prompts) + \count($this->resourceTemplates);
    }
    /**
    ...
    {
        return ['tools' => \count($this->tools), 'resources' => \count($this->resources), 'prompts' => \count($this->prompts), 'resourceTemplates' => \count($this->resourceTemplates)];
    }
}
