 ...
 */
namespace Matomo\Dependencies\McpServer\Mcp\Capability\Logger;
...
{
    public function __construct(private ClientGateway $client, private SessionInterface $session)
    {
    }
    /**
    ...
    public function log($level, $message, array $context = []) : void
    {
        ...
        if (null === $mcpLevel) {
            return;
            // Unknown level, skip MCP notification
        }
