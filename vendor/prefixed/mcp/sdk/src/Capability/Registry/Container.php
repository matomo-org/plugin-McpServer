...
use Matomo\Dependencies\McpServer\Mcp\Exception\ContainerException;
use Matomo\Dependencies\McpServer\Mcp\Exception\ServiceNotFoundException;
...
final class Container implements ContainerInterface
{
    ...
    public function get(string $id) : mixed
    {
        ...
        if (!class_exists($id) && !interface_exists($id)) {
            // Also check interface for bindings
        ...
        try {
            ...
            // Re-throw container exceptions directly
            throw $e;
        } catch (\Throwable $e) {
