 ...
 */
namespace Matomo\Dependencies\McpServer\Mcp\Exception;
...
{
    public function __construct(public readonly ClientCapabilities $requiredCapabilities, string $message = 'Request requires a client capability that was not declared.')
    {
