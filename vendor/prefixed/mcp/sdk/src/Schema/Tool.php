...
class Tool implements \JsonSerializable
{
     ...
     */
    public function __construct(public readonly string $name, public readonly array $inputSchema, public readonly ?string $description, public readonly ?ToolAnnotations $annotations, public readonly ?array $icons = null, public readonly ?array $meta = null, public readonly ?array $outputSchema = null)
    {
    ...
    {
        $data = ['name' => $this->name, 'inputSchema' => $this->inputSchema];
