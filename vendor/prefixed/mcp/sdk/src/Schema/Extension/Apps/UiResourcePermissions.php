...
{
    public function __construct(public readonly bool $camera = \false, public readonly bool $microphone = \false, public readonly bool $geolocation = \false, public readonly bool $clipboardWrite = \false)
    {
    }
    /**
    ...
    public static function fromArray(array $data) : self
    {
        ...
        return new self(camera: isset($data['camera']), microphone: isset($data['microphone']), geolocation: isset($data['geolocation']), clipboardWrite: isset($data['clipboardWrite']));
    }
    /**
