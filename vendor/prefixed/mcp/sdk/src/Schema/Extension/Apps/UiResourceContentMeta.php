...
{
    public function __construct(public readonly ?UiResourceCsp $csp = null, public readonly ?UiResourcePermissions $permissions = null, public readonly ?string $domain = null, public readonly ?bool $prefersBorder = null)
    {
    }
    /**
    ...
    public static function fromArray(array $data) : self
    {
        ...
        return new self(csp: isset($data['csp']) ? UiResourceCsp::fromArray($data['csp']) : null, permissions: isset($data['permissions']) ? UiResourcePermissions::fromArray($data['permissions']) : null, domain: $data['domain'] ?? null, prefersBorder: $data['prefersBorder'] ?? null);
    }
    /**
     * @return array{
     *     csp?: UiResourceCsp,
