...
final class ToolUseContent extends Content
{
     ...
     */
    public function __construct(public readonly string $id, public readonly string $name, public readonly array $input, public readonly ?array $meta = null)
    {
    ...
    public static function fromArray(array $data) : self
    {
        ...
        return new self($data['id'], $data['name'], $data['input'], $data['_meta'] ?? null);
    }
    /**
    ...
    {
        $data = ['type' => $this->type, 'id' => $this->id, 'name' => $this->name, 'input' => $this->input ?: new \stdClass()];
        if (null !== $this->meta) {
