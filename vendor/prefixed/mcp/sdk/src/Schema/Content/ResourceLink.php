...
class ResourceLink extends Content
{
    ...
    {
        $data = ['type' => $this->type, 'uri' => $this->uri, 'name' => $this->name];
        if (null !== $this->title) {
