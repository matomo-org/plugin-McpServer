 ...
 */
namespace Matomo\Dependencies\McpServer\Mcp\Schema\Content;
...
final class ToolResultContent extends Content
{
     ...
     */
    public function __construct(public readonly string $toolUseId, array $content, public readonly ?array $structuredContent = null, public readonly bool $isError = \false, public readonly ?array $meta = null)
    {
    ...
    public static function fromArray(array $data) : self
    {
        ...
        return new self($data['toolUseId'], $content, isset($data['structuredContent']) && \is_array($data['structuredContent']) ? $data['structuredContent'] : null, isset($data['isError']) && \true === $data['isError'], isset($data['_meta']) && \is_array($data['_meta']) ? $data['_meta'] : null);
    }
    /**
    ...
    {
        $data = ['type' => $this->type, 'toolUseId' => $this->toolUseId, 'content' => $this->content];
