...
class ImageContent extends Content
{
     ...
     */
    public function __construct(public readonly string $data, public readonly string $mimeType, public readonly ?Annotations $annotations = null)
    {
    ...
    {
        $result = ['type' => $this->type, 'data' => $this->data, 'mimeType' => $this->mimeType];
