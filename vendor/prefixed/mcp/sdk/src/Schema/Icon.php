...
use Matomo\Dependencies\McpServer\Mcp\Schema\Enum\IconTheme;
/**
...
class Icon implements \JsonSerializable
{
     ...
     */
    public function __construct(public readonly string $src, public readonly ?string $mimeType = null, public readonly ?array $sizes = null, public readonly ?IconTheme $theme = null)
    {
        if (empty($src)) {
    ...
    {
        return array_map(static function (mixed $icon) use($context) : self {
            if (!\is_array($icon)) {
