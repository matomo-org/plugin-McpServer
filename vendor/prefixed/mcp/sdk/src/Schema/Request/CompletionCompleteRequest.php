...
final class CompletionCompleteRequest extends Request
{
     ...
     */
    public function __construct(public readonly PromptReference|ResourceReference $ref, public readonly array $argument)
    {
    }
    ...
    {
        return ['ref' => $this->ref, 'argument' => $this->argument];
    }
}
