...
use Matomo\Dependencies\McpServer\Mcp\Schema\Content\ToolResultContent;
use Matomo\Dependencies\McpServer\Mcp\Schema\Content\ToolUseContent;
...
final class CreateSamplingMessageRequest extends Request
{
    ...
    protected static function fromParams(?array $params) : static
    {
        ...
        return new self($messages, $params['maxTokens'], $preferences, $params['systemPrompt'] ?? null, $includeContext, isset($params['temperature']) ? (float) $params['temperature'] : null, $params['stopSequences'] ?? null, $params['metadata'] ?? null, $tools, $toolChoice);
    }
    /**
    ...
    public function validateToolFlow() : void
    {
        ...
        foreach ($this->messages as $message) {
            ...
            foreach ($toolResults as $toolResult) {
                $matched = array_search($toolResult->toolUseId, $pendingToolUseIds, \true);
                if (\false === $matched) {
    ...
    {
        $params = ['messages' => $this->messages, 'maxTokens' => $this->maxTokens];
