...
final class ElicitRequest extends Request
{
     ...
     */
    public function __construct(public readonly string $message, public readonly ElicitationSchema $requestedSchema)
    {
    }
    ...
    protected static function fromParams(?array $params) : static
    {
        ...
        return new self($params['message'], ElicitationSchema::fromArray($params['requestedSchema']));
    }
    /**
     * @return array{
     *     message: string,
