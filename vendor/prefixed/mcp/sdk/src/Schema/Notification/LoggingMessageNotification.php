...
class LoggingMessageNotification extends Notification
{
     ...
     */
    public function __construct(public readonly LoggingLevel $level, public readonly mixed $data, public readonly ?string $logger = null)
    {
    }
    ...
    {
        $params = ['level' => $this->level->value, 'data' => $this->data];
        if (null !== $this->logger) {
