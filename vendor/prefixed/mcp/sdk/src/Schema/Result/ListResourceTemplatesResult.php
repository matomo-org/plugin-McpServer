...
class ListResourceTemplatesResult implements ResultInterface
{
     ...
     */
    public function __construct(public readonly array $resourceTemplates, public readonly ?string $nextCursor = null)
    {
    }
    /**
     * @param array{
    ...
    public static function fromArray(array $data) : self
    {
        ...
        return new self(array_map(static function (mixed $entry) : ResourceTemplate {
            if (!\is_array($entry)) {
        ...
        }, $data['resourceTemplates']), $data['nextCursor'] ?? null);
    }
    /**
     * @return array{
    ...
    {
        $result = ['resourceTemplates' => array_values($this->resourceTemplates)];
        if ($this->nextCursor) {
