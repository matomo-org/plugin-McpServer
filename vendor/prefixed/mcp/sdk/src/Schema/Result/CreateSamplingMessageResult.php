...
class CreateSamplingMessageResult implements ResultInterface
{
     ...
     */
    public function __construct(public readonly Role $role, TextContent|ImageContent|AudioContent|ToolUseContent|array $content, public readonly string $model, public readonly ?string $stopReason = null, public readonly ?array $meta = null)
    {
    ...
    public static function fromArray(array $data) : self
    {
        ...
        return new self($role, $isSingleContent ? $content[0] : $content, $data['model'], $stopReason, isset($data['_meta']) && \is_array($data['_meta']) ? $data['_meta'] : null);
    }
    /**
    ...
    {
        $result = ['role' => $this->role->value, 'content' => $this->content, 'model' => $this->model];
