...
use Matomo\Dependencies\McpServer\Mcp\Schema\Enum\ElicitAction;
...
final class ElicitResult implements ResultInterface
{
     ...
     */
    public function __construct(public readonly ElicitAction $action, public readonly ?array $content = null)
    {
    }
    /**
