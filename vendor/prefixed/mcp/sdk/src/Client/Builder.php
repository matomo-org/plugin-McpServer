...
use Matomo\Dependencies\McpServer\Mcp\Client;
...
final class Builder
{
    ...
    public function build() : Client
    {
        ...
        $clientInfo = new Implementation($this->name, $this->version, $this->description, title: $this->title);
        ...
        $config = new Configuration(clientInfo: $clientInfo, capabilities: $capabilities, protocolVersion: $this->protocolVersion ?? ProtocolVersion::V2025_11_25, initTimeout: $this->initTimeout, requestTimeout: $this->requestTimeout, maxRetries: $this->maxRetries);
