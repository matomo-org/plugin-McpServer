...
use Matomo\Dependencies\McpServer\Mcp\Exception\RootsException;
...
{
    public function __construct(private readonly RootsCallbackInterface $callback, private readonly LoggerInterface $logger = new NullLogger())
    {
