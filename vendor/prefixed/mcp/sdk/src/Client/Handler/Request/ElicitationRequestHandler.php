...
use Matomo\Dependencies\McpServer\Mcp\Exception\ElicitationException;
...
{
    public function __construct(private readonly ElicitationCallbackInterface $callback, private readonly LoggerInterface $logger = new NullLogger())
    {
    }
