 ...
 */
namespace Matomo\Dependencies\McpServer\Mcp\JsonRpc;
...
use Matomo\Dependencies\McpServer\Mcp\Schema;
...
final class MessageFactory
{
     ...
     */
    public function __construct(private readonly array $registeredMessages, private readonly int $maxBatchSize = self::DEFAULT_MAX_BATCH_SIZE)
    {
