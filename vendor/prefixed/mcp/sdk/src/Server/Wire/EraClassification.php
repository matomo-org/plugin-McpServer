...
{
    private function __construct(public readonly bool $modern, public readonly ?string $claimedVersion, public readonly ?Error $error, public readonly int $httpStatus)
    {
    }
    /**
    ...
    {
        return new self(\true, $version, null, 200);
    }
