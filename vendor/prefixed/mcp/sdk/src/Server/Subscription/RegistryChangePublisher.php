 ...
 */
namespace Matomo\Dependencies\McpServer\Mcp\Server\Subscription;
...
{
    public function __construct(private readonly NotificationBusInterface $bus)
    {
    }
    ...
    {
        return [ToolListChangedEvent::class => $this->onToolListChanged(...), PromptListChangedEvent::class => $this->onPromptListChanged(...), ResourceListChangedEvent::class => $this->onResourceListChanged(...), ResourceTemplateListChangedEvent::class => $this->onResourceTemplateListChanged(...)];
    }
}
