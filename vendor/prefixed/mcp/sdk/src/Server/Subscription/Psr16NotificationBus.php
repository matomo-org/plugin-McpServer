...
final class Psr16NotificationBus implements NotificationBusInterface
{
     ...
     */
    public function __construct(private readonly CacheInterface $cache, private readonly string $prefix = 'mcp.notifications.', private readonly int $ttl = 120, private readonly int $backlog = 256, private readonly LoggerInterface $logger = new NullLogger(), ?MessageFactory $messageFactory = null)
    {
        if ($this->backlog < 1) {
