...
use Matomo\Dependencies\McpServer\Mcp\Server\Transport\Http\OAuth\AuthorizationResult;
use Matomo\Dependencies\McpServer\Mcp\Server\Transport\Http\OAuth\AuthorizationTokenValidatorInterface;
...
final class AuthorizationMiddleware implements MiddlewareInterface
{
     ...
     */
    public function __construct(private AuthorizationTokenValidatorInterface $validator, private ProtectedResourceMetadata $resourceMetadata, ?ResponseFactoryInterface $responseFactory = null)
    {
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler) : ResponseInterface
    {
        ...
        if (null === $accessToken) {
            return $this->buildErrorResponse($request, AuthorizationResult::badRequest('invalid_request', 'Malformed Authorization header.'));
        }
