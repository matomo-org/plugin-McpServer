...
final class DnsRebindingProtectionMiddleware implements MiddlewareInterface
{
     ...
     */
    public function __construct(array $allowedHosts = ['localhost', '127.0.0.1', '[::1]'], ?ResponseFactoryInterface $responseFactory = null, ?StreamFactoryInterface $streamFactory = null)
    {
    ...
    private function isAllowedOrigin(string $origin) : bool
    {
        ...
        return \in_array(strtolower($host), $this->allowedHosts, \true);
    }
    private function isAllowedHost(string $host) : bool
    {
        ...
        return \in_array(strtolower($hostname), $this->allowedHosts, \true);
    }
    private function createForbiddenResponse(string $message) : ResponseInterface
    {
        return $this->responseFactory->createResponse(403)->withHeader('Content-Type', 'text/plain')->withBody($this->streamFactory->createStream($message));
    }
}
