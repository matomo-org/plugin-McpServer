...
use Matomo\Dependencies\McpServer\Mcp\Server\Transport\Http\JsonRpcErrorResponse;
...
final class ProtocolVersionMiddleware implements MiddlewareInterface
{
     ...
     */
    public function __construct(?array $supportedVersions = null, ?ResponseFactoryInterface $responseFactory = null, ?StreamFactoryInterface $streamFactory = null)
    {
