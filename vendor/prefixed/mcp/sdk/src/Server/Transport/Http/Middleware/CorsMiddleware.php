...
final class CorsMiddleware implements MiddlewareInterface
{
     ...
     */
    public function __construct(private readonly array $allowedOrigins = [], array $allowedMethods = ['GET', 'POST', 'DELETE'], array $allowedHeaders = ['Accept', 'Authorization', 'Content-Type', 'Last-Event-ID', StreamableHttpTransport::PROTOCOL_VERSION_HEADER, StreamableHttpTransport::SESSION_HEADER], array $exposedHeaders = [StreamableHttpTransport::SESSION_HEADER], private readonly bool $allowCredentials = \false)
    {
        $this->isWildcard = \in_array('*', $allowedOrigins, \true);
    ...
    private function resolveAllowedOrigin(string $origin) : ?string
    {
        ...
        if ('' !== $origin && \in_array($origin, $this->allowedOrigins, \true)) {
            return $origin;
        }
        return null;
    }
