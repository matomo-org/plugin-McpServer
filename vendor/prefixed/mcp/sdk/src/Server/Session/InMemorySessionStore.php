...
class InMemorySessionStore implements SessionStoreInterface
{
    ...
    public function __construct(protected readonly int $ttl = 3600, protected readonly ClockInterface $clock = new NativeClock())
    {
    }
    ...
    {
        $this->store[$id->toRfc4122()] = ['data' => $data, 'timestamp' => $this->clock->now()->getTimestamp()];
        return \true;
    }
