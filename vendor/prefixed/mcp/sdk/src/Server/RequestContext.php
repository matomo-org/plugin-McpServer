...
use Matomo\Dependencies\McpServer\Mcp\Capability\Logger\ClientLogger;
...
final class RequestContext
{
    ...
    public function __construct(private readonly SessionInterface $session, private readonly Request $request)
    {
    }
    ...
    {
        $requested = $this->request->getMeta()[self::PROTOCOL_VERSION_META_KEY] ?? $this->session->get('protocol_version');
