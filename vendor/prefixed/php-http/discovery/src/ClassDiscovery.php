...
use Matomo\Dependencies\McpServer\Http\Discovery\Exception\ClassInstantiationFailedException;
use Matomo\Dependencies\McpServer\Http\Discovery\Exception\DiscoveryFailedException;
use Matomo\Dependencies\McpServer\Http\Discovery\Exception\NoCandidateFoundException;
use Matomo\Dependencies\McpServer\Http\Discovery\Exception\StrategyUnavailableException;
use Matomo\Dependencies\McpServer\Http\Discovery\Strategy\DiscoveryStrategy;
/**
