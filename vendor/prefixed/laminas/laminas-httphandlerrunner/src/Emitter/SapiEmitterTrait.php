...
use Matomo\Dependencies\McpServer\Laminas\HttpHandlerRunner\Exception\EmitterException;
...
trait SapiEmitterTrait
{
    ...
    {
        if (function_exists('Matomo\\Dependencies\\McpServer\\Laminas\\HttpHandlerRunner\\Emitter\\headers_sent')) {
            // phpcs:ignore SlevomatCodingStandard.Namespaces.ReferenceUsedNamesOnly.ReferenceViaFullyQualifiedName
            return \Matomo\Dependencies\McpServer\Laminas\HttpHandlerRunner\Emitter\headers_sent($filename, $line);
        }
        return headers_sent($filename, $line);
    }
    private function header(string $headerName, bool $replace, int $statusCode) : void
    {
        if (function_exists('Matomo\\Dependencies\\McpServer\\Laminas\\HttpHandlerRunner\\Emitter\\header')) {
            // phpcs:ignore SlevomatCodingStandard.Namespaces.ReferenceUsedNamesOnly.ReferenceViaFullyQualifiedName
            \Matomo\Dependencies\McpServer\Laminas\HttpHandlerRunner\Emitter\header($headerName, $replace, $statusCode);
            return;
        }
