 ...
 */
namespace Matomo\Dependencies\McpServer\Symfony\Component\Uid;
...
class Uuid extends AbstractUid
{
    ...
    public static final function v1() : UuidV1
    {
        return new UuidV1();
    }
    public static final function v3(self $namespace, string $name) : UuidV3
    {
    ...
    public static final function v4() : UuidV4
    {
        return new UuidV4();
    }
    public static final function v5(self $namespace, string $name) : UuidV5
    {
    ...
    public static final function v6() : UuidV6
    {
        return new UuidV6();
    }
    public static final function v7() : UuidV7
    {
        return new UuidV7();
    }
    public static final function v8(string $uuid) : UuidV8
    {
