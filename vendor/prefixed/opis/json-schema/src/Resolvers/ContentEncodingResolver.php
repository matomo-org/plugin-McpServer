...
class ContentEncodingResolver
{
    ...
    {
        $list += ['binary' => self::class . '::DecodeBinary', 'base64' => self::class . '::DecodeBase64', 'quoted-printable' => self::class . '::DecodeQuotedPrintable'];
        $this->list = $list;
    ...
    {
        return ['list' => $this->list, 'defaultEncoding' => $this->defaultEncoding];
    }
