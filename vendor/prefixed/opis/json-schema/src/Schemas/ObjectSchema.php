...
use Matomo\Dependencies\McpServer\Opis\JsonSchema\KeywordValidators\CallbackKeywordValidator;
class ObjectSchema extends AbstractSchema
{
    ...
    protected function applyKeywords(array $keywords, ValidationContext $context) : ?ValidationError
    {
        ...
        return new ValidationError('', $this, DataInfo::fromContext($context), 'Data must match schema', [], $error_list);
    }
}
