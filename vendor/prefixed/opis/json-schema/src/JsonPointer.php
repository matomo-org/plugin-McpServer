...
final class JsonPointer
{
    ...
    protected final function __construct(array $path, int $level = -1, int $shift = 0, bool $fragment = \false)
    {
        $this->path = $path;
    ...
    public static function parse(string $pointer, bool $decode = \true) : ?self
    {
        ...
        $level = isset($m['level']) && $m['level'] !== '' ? (int) $m['level'] : -1;
        $shift = 0;
