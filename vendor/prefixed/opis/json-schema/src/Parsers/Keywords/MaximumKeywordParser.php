...
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Keywords\ExclusiveMaximumDataKeyword;
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Keywords\ExclusiveMaximumKeyword;
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Keywords\MaximumDataKeyword;
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Keywords\MaximumKeyword;
    ...
    public function parse(SchemaInfo $info, SchemaParser $parser, object $shared) : ?Keyword
    {
        ...
        if ($this->isDataKeywordAllowed($parser, $this->keyword)) {
            if ($pointer = $this->getDataKeywordPointer($value)) {
                return $exclusive ? new ExclusiveMaximumDataKeyword($pointer) : new MaximumDataKeyword($pointer);
            }
        }
        ...
        return $exclusive ? new ExclusiveMaximumKeyword($value) : new MaximumKeyword($value);
    }
}
