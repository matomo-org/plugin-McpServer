...
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Keywords\DefaultKeyword;
...
class DefaultKeywordParser extends KeywordParser
{
    ...
    public function parse(SchemaInfo $info, SchemaParser $parser, object $shared) : ?Keyword
    {
        ...
        if ($this->properties !== null && property_exists($schema, $this->properties) && is_object($schema->{$this->properties})) {
