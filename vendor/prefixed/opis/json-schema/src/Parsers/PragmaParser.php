...
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Exceptions\InvalidPragmaException;
...
abstract class PragmaParser
{
     ...
     * @return Pragma|null
     */
    public abstract function parse(SchemaInfo $info, SchemaParser $parser, object $shared) : ?Pragma;
    /**
