 ...
 * ============================================================================ */
namespace Matomo\Dependencies\McpServer\Opis\JsonSchema\Parsers\KeywordValidators;
...
use Matomo\Dependencies\McpServer\Opis\JsonSchema\KeywordValidators\PragmaKeywordValidator;
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Parsers\KeywordValidatorParser;
...
class PragmaKeywordValidatorParser extends KeywordValidatorParser
{
    ...
    public function parse(SchemaInfo $info, SchemaParser $parser, object $shared) : ?KeywordValidator
    {
        ...
        $pragmaInfo = new SchemaInfo($value, null, $info->id() ?? $info->base(), $info->root(), array_merge($info->path(), [$this->keyword]), $draft);
