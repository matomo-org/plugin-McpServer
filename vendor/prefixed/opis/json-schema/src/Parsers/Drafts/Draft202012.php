...
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Parsers\Keywords\ContentSchemaKeywordParser;
...
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Parsers\Keywords\DependentRequiredKeywordParser;
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Parsers\Keywords\DependentSchemasKeywordParser;
...
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Parsers\Keywords\IfThenElseKeywordParser;
...
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Parsers\Keywords\UnevaluatedItemsKeywordParser;
use Matomo\Dependencies\McpServer\Opis\JsonSchema\Parsers\Keywords\UnevaluatedPropertiesKeywordParser;
...
class Draft202012 extends Draft
{
    ...
    {
        return new RefKeywordParser('$ref', [['ref' => '$dynamicRef', 'anchor' => '$dynamicAnchor', 'fragment' => \true], ['ref' => '$recursiveRef', 'anchor' => '$recursiveAnchor', 'fragment' => \false]]);
    }
    /**
     * @inheritDoc
     */
    protected function getKeywordParsers() : array
    {
        return [
            ...
            // keep for draft-07 compatibility
