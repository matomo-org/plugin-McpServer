...
abstract class Draft extends Vocabulary
{
     ...
     * @return bool
     */
    public abstract function allowKeywordsAlongsideRef() : bool;
    /**
     * @return bool
     */
    public abstract function supportsAnchorId() : bool;
    /**
     * @return KeywordParser
     */
    protected abstract function getRefKeywordParser() : KeywordParser;
    /**
     * @return KeywordParser[]
     */
    protected abstract function getKeywordParsers() : array;
    /**
