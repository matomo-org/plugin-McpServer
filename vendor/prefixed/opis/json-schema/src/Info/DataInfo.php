 ...
 * ============================================================================ */
namespace Matomo\Dependencies\McpServer\Opis\JsonSchema\Info;
...
class DataInfo
{
    ...
    public static function fromContext(ValidationContext $context) : self
    {
        ...
        return new self($context->currentData(), $context->currentDataType(), $context->rootData(), $context->currentDataPath(), $parent);
    }
}
