...
class UnevaluatedItemsKeyword implements Keyword
{
    ...
    public function validate(ValidationContext $context, Schema $schema) : ?ValidationError
    {
        ...
        if ($this->value === \false) {
            return $this->error($schema, $context, 'unevaluatedItems', 'Unevaluated array items are not allowed: {indexes}', ['indexes' => $unevaluated]);
        }
        ...
        $error = $this->validateIterableData($schema, $this->value, $context, $unevaluated, 'unevaluatedItems', 'All unevaluated array items must match schema: {indexes}', ['indexes' => $unevaluated], $object);
