...
class AdditionalItemsKeyword implements Keyword
{
    ...
    public function validate(ValidationContext $context, Schema $schema) : ?ValidationError
    {
        ...
        if ($this->value === \false) {
            return $this->error($schema, $context, 'additionalItems', 'Array should not have additional items', ['index' => $this->index]);
        }
        ...
        $error = $this->validateIterableData($schema, $this->value, $context, $this->indexes($this->index, $count), 'additionalItems', 'All additional array items must match schema', [], $object);
