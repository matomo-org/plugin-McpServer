...
class UnevaluatedPropertiesKeyword implements Keyword
{
    ...
    public function validate(ValidationContext $context, Schema $schema) : ?ValidationError
    {
        ...
        if ($this->value === \false) {
            return $this->error($schema, $context, 'unevaluatedProperties', 'Unevaluated object properties not allowed: {properties}', ['properties' => $unevaluated]);
        }
        ...
        $error = $this->validateIterableData($schema, $this->value, $context, $unevaluated, 'unevaluatedProperties', 'All unevaluated object properties must match schema: {properties}', ['properties' => $unevaluated], $object);
