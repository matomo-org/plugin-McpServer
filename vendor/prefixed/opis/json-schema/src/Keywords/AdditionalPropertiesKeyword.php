...
class AdditionalPropertiesKeyword implements Keyword
{
    ...
    public function validate(ValidationContext $context, Schema $schema) : ?ValidationError
    {
        ...
        if ($this->value === \false) {
            return $this->error($schema, $context, 'additionalProperties', 'Additional object properties are not allowed: {properties}', ['properties' => $props]);
        }
        ...
        $error = $this->validateIterableData($schema, $this->value, $context, $props, 'additionalProperties', 'All additional object properties must match schema: {properties}', ['properties' => $props], $object);
