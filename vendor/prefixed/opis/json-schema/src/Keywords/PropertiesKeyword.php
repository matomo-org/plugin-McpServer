    ...
    public function validate(ValidationContext $context, Schema $schema) : ?ValidationError
    {
        ...
        foreach ($this->properties as $name => $prop) {
            ...
            if ($prop === \false) {
                ...
                return $this->error($schema, $context, 'properties', "Property '{property}' is not allowed", ['property' => $name]);
            }
        ...
        $context->addEvaluatedProperties($evaluated);
        if (!$errors->isEmpty()) {
            return $this->error($schema, $context, 'properties', "The properties must match schema: {properties}", ['properties' => array_values(array_diff($checked, $evaluated))], $errors);
        }
        unset($errors);
