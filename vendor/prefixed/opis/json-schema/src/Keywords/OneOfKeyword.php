...
class OneOfKeyword implements Keyword
{
    ...
    public function validate(ValidationContext $context, Schema $schema) : ?ValidationError
    {
        ...
        foreach ($this->value as $index => $value) {
            ...
            if ($value === \true) {
                if (++$count > 1) {
                    ...
                    return $this->error($schema, $context, 'oneOf', 'The data should match exactly one schema', ['matched' => [$matchedIndex, $index]]);
                }
                $matchedIndex = $index;
                continue;
            }
        ...
        return $this->error($schema, $context, 'oneOf', 'The data should match exactly one schema', ['matched' => []], $errors);
    }
}
