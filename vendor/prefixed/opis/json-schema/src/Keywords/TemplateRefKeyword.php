 ...
 * ============================================================================ */
namespace Matomo\Dependencies\McpServer\Opis\JsonSchema\Keywords;
...
class TemplateRefKeyword extends AbstractRefKeyword
{
    ...
    public function __construct(UriTemplate $template, ?Variables $vars, ?Variables $mapper = null, ?Variables $globals = null, ?array $slots = null, string $keyword = '$ref', bool $allowRelativeJsonPointerInRef = \true)
    {
