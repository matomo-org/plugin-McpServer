    ...
    public function validate(ValidationContext $context, Schema $schema) : ?ValidationError
    {
        ...
        foreach ($this->value as $index => $value) {
            ...
            if ($value === \false) {
                ...
                return $this->error($schema, $context, 'allOf', 'The data should match all schemas', ['index' => $index]);
            }
            ...
            if ($error = $context->validateSchemaWithoutEvaluated($value, null, \false, $object)) {
                $this->addEvaluatedFromArrayObject($object, $context);
                return $this->error($schema, $context, 'allOf', 'The data should match all schemas', ['index' => $index], $error);
            }
        }
        $this->addEvaluatedFromArrayObject($object, $context);
        return null;
