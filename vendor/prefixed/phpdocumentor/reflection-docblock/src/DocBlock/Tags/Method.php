...
final class Method extends BaseTag
{
     ...
     */
    public function __construct(string $methodName, array $parameters = [], ?Type $returnType = null, bool $static = \false, ?Description $description = null, bool $returnsReference = \false)
    {
